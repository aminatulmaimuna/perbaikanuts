...
public class PerbaikanUTS {
    public static void main(String[] args) {
        ...
        input.add(new Mahasiswa("mei", "Manajemen syariah", 4, 84));
        input.add(new Mahasiswa("nana", "Bahasa indonesia", 2, 80));
        input.add(new Mahasiswa("ami", "Pengantar filsafat", 2, 84));
        input.add(new Mahasiswa("lala", "Pemrograman", 1, 92));
        input.add(new Mahasiswa("nini", "Civic education", 3, 88));
